        ...
        success: function(data){
            $('#showdetail').empty()
                $('#showdetail').append(
                    ...
                    "<li>Series : <strong>"+data.series+"</strong></li>"+
                    "<li>Số dây: <strong>"+data.numstring+"</strong></li>"+
                    "<li>Dây Đàn: <strong>"+data.string+"</strong></li>"+
                    "<li>Bảo hành: <strong>"+data.time+"</strong></li></ul>"+
                    "<a class='btn btn-danger'>Buy</a> <a class='btn btn-warning'><i class='fa fa-cart-plus'></i></a> <a class='btn btn-primary' onclick='remove()'><i class='fa fa-times' onclick='no()'></i></a></div><div>"
                )
        ...
        success: function(data){
            $('#showdetail').empty()
                $('#showdetail').append(
                    ...
                    "<a class='btn btn-danger' style='color: white;' onclick='cus.confirm("+data.id+")'>Confirm</a> <a class='btn btn-warning'><i class='fa fa-times'></i></a></form></div><div>"
                )
