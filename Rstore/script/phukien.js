...
acou.drawTable = function () {
    $.ajax({
        url: ' https://rstorecompany.herokuapp.com/capo',
        method: "GET",
        dataType: "JSON",
...
acou3.drawTable = function () {
    $.ajax({
        url: ' https://rstorecompany.herokuapp.com/soundeffect',
        method: "GET",
        dataType: "JSON",
        success: function (data) {
            $('#tbAcou3').empty();
...
detail.showdetail = function (id){
    ...
    $.ajax({
        url: 'https://rstorecompany.herokuapp.com/capo/'+id,
        method: 'GET',
        dataType: "JSON",
        success: function(data){
            $('#showdetail').empty()
                $('#showdetail').append(
                    ...
                    "<li>Mô tả: <strong>"+data.decri+"</strong></li></ul>"+
...
detail.showdetail3 = function (id){
    ...
    $.ajax({
        url: ' https://rstorecompany.herokuapp.com/soundeffect/'+id,
        method: 'GET',
        dataType: "JSON",
        success: function(data){
            $('#showdetail').empty()
