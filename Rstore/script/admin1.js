...
product.drawTable = function (){
    $.ajax({
        url: 'https://rstorecompany.herokuapp.com/acouticsguitar1',
        method: "GET",
        dataType: "JSON",
...
product.save = function(){
    ...
    if($('#formAddEditProduct').valid()){
        if($('#id').val() ==0){
            ...
            $.ajax({
                url: 'https://rstorecompany.herokuapp.com/acouticsguitar1/' +productObj.id,
                method: "PUT",
                dataType: "JSON",
                contentType: "application/JSON",
                data : JSON.stringify(productObj),
...
product.get = function (id){
    $.ajax({
        url: 'https://rstorecompany.herokuapp.com/acouticsguitar1/' +id,
        method : "GET",
        dataType : "JSON",
        success : function(data){
            $('#Name').val(data.name);
