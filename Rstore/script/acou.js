...
acou2.drawTable = function () {
    $.ajax({
        url: 'https://rstorecompany.herokuapp.com/acouticsguitar2',
        method: "GET",
        dataType: "JSON",
        success: function (data) {
            $('#tbAcou2').empty();
            $.each(data,function (i,v) {
                $('#tbAcou2').append(
                    "<div class='col-md-6 col-lg-4 mb-5' data-aos='fade-up' data-aos-delay='100'>"+
                    "  <a href='#' class='unit-9' target='blank'>"+
                    "<div class='image' style=' "+'background-image: url('+v.image+');'+"'></div>"+
                    "<div class='unit-9-content'>"+
                    "  <h2>"+v.name+"</h2>"+
                    "<span>"+v.price+"₫</span>"+
                    "  </div></a><br>"+
                    "<a class='btn btn-danger' href='#go' onclick='acou2.buy("+v.id+")'>Buy</a>"+
                    " <a class='btn btn-warning'><i class='fa fa-cart-plus'></i></a> "+
                    "<a class='btn btn-info' href='#go' onclick='detail.showdetail2("+v.id+")'>Details</a>"+
                    "</div>"
...
acou3.drawTable = function () {
    $.ajax({
        url: 'https://rstorecompany.herokuapp.com/acouticsguitar3',
        method: "GET",
        dataType: "JSON",
        success: function (data) {
            $('#tbAcou3').empty();
            $.each(data,function (i,v) {
                $('#tbAcou3').append(
                    ...
                    "<span>"+v.price+"₫</span>"+
                    "  </div></a><br>"+
                    "<a class='btn btn-danger' href='#go' onclick='acou3.buy("+v.id+")'>Buy</a>"+
                    " <a class='btn btn-warning'><i class='fa fa-cart-plus'></i></a> "+
                    "<a class='btn btn-info' href='#go' onclick='detail.showdetail3("+v.id+")'>Details</a>"+
                    "</div>"
...
detail.showdetail2 = function (id){
 
    $.ajax({
        url: 'https://rstorecompany.herokuapp.com/acouticsguitar2/'+id,
        method: 'GET',
        dataType: "JSON",
        success: function(data){
            $('#showdetail').empty()
...
detail.showdetail3 = function (id){
 
    $.ajax({
        url: 'https://rstorecompany.herokuapp.com/acouticsguitar3/'+id,
        method: 'GET',
        dataType: "JSON",
        success: function(data){
            $('#showdetail').empty()
        ...
        success: function(data){
            $('#showdetail').empty()
                $('#showdetail').append(
                    ...
                    "<li class='text-black'>Product Name: <input type='text' id='productname"+data.id+"' class='form-control' readonly value='"+data.name+"'></li>"+
                    "<li class='text-black'>Price: <input type='number' id='price"+data.id+"' class='form-control' readonly value='"+data.price+"'></li>"+
                    "<a class='btn btn-danger' style='color: white;' onclick='cus.confirm2("+data.id+")'>Confirm</a> <a class='btn btn-warning'><i class='fa fa-times' onclick='no()'></i></a></form></div><div>"
                )
           
        }
    })
}
acou3.buy = function (id){
    $.ajax({
        url: 'https://rstorecompany.herokuapp.com/acouticsguitar3/'+id,
        method: 'GET',
        dataType: "JSON",
        success: function(data){
            $('#showdetail').empty()
                $('#showdetail').append(
                    ...
                    "<li class='text-black'>Product Name: <input type='text' id='productname"+data.id+"' class='form-control' readonly value='"+data.name+"'></li>"+
                    "<li class='text-black'>Price: <input type='number' id='price"+data.id+"' class='form-control' readonly value='"+data.price+"'></li>"+
                    "<a class='btn btn-danger' style='color: white;' onclick='cus.confirm3("+data.id+")'>Confirm</a> <a class='btn btn-warning'><i class='fa fa-times' onclick='no()'></i></a></form></div><div>"
                )
        ...
        success : function(data){
            ...
            $.each(data, function(i,v){
                $('#tbcusscriber').append(
                    ...
                    "<td>"+v.price+"</td>"+
                    "<td >"+
                    "<a href ='javascript:;' onclick='cus.mail("+v.id+")'     title='mail'><i class='fa fa-envelope' ></i></a> "+
